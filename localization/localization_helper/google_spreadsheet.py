...
# at ~/.credentials/sheets.googleapis.localization.json
...
def get_credentials(client_secret_file, scopes):
    ...
    credential_path = os.path.join(credential_dir,
                                   'sheets.googleapis.localization.json')
...
def deal_with_auth_and_prepare_api_service(client_secret_file, scopes):
